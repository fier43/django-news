...
class AppointmentView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        msg = EmailMultiAlternatives(
            ...
            from_email='DimonDexp@yandex.ru', # здесь указываете почту, с которой будете отправлять (об этом попозже)
            to=['gena-zub96@mail.ru', ],  # это то же, что и recipients_list
        )
